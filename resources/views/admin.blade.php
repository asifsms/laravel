		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">Hikester</a>
				...
				<div class="collapse navbar-collapse navbar-right" id="navbar">
					<div class="top-nav">
						...
						<a class="hover-effect scroll" href="{{ route('logout') }}"
				...
				<section class="slider ">
					<div class="flexslider tab-pane">
						<ul class="slides">
							...
							<li>
								<h4>"Manali-Solang valley-Kasol"</h4>
								<div class="gallery-grids">
									<a class="example-image-link" href="{{ asset('images/kasol-solang.jpg') }}"
										data-lightbox="example-set" data-title="">
										<div class="col-md-5 col-sm-5 tab-image">
											<img src="{{ asset('images/kasol-solang.jpg') }}" alt="Hikester">
										</div>
									</a></div>
